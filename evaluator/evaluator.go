...
func applyFunction(fn object.Object, args []object.Object) object.Object {
	...
	// make new environment for function
	extendedEnv := extendFunctionEnv(function, args)

	evaluated := Eval(function.Body, extendedEnv)

	// dont stop main thread, we just need to return value
	// if not unwrap, we get *object.ReturnValue
	// if unwrap, we get *object.Object
...
func extendFunctionEnv(fn *object.Function, args []object.Object) *object.Environment {
	...
	for paramIdx, param := range fn.Parameters {
		...
		// bind argument to local environment
...
func isTruthy(obj object.Object) bool {
	...
	// Important: truthy is not only boolean
	default:
		return true
